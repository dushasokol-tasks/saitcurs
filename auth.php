...
<div>
<div>
    <form action="auth1.php" method="post" class="box">
        <div class="form" class="form" style="border: 1px solid #3a3a3a;
    padding: 10px;
    margin-top: 10px;
border-radius: 10px;
width: 400px;
margin-left: 450px">
    ...
    font-size: 25px;
margin-top: 5px">
                <?echo "Вход в почтовый ящик"?>
            </div>
            <div style="margin-bottom: 20px">
                <input style="height: 30px; width: 400px" type="text" name="login" placeholder="Введите логин" class="inp">
            </div>
            <div style="margin-bottom: 20px">
                <input style="height: 30px; width: 400px" type="password" name="password" placeholder="Введите пароль" class="inp">
            </div>
